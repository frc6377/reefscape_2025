 ...
 */
public class DebugWatchdog implements Closeable, Comparable<DebugWatchdog> {
  ...
  private final NTTracer m_tracer;

  private static final PriorityQueue<DebugWatchdog> m_watchdogs = new PriorityQueue<>();
  ...
  static {
    ...
    startDaemonThread(DebugWatchdog::schedulerFunc);
  }
   ...
   */
  public DebugWatchdog(double timeoutSeconds, Runnable callback) {
    m_timeoutSeconds = timeoutSeconds;
    m_callback = callback;
    m_tracer = new NTTracer();
  }
  ...
  public boolean equals(Object obj) {
    return obj instanceof DebugWatchdog watchdog
  ...
  @Override
  public int compareTo(DebugWatchdog rhs) {
  ...
  private static void schedulerFunc() {
    while (!Thread.currentThread().isInterrupted()) {
      ...
      try {
        ...
        DebugWatchdog watchdog = m_watchdogs.poll();
