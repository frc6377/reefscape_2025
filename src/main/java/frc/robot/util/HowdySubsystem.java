...
public class HowdySubsystem implements Subsystem, Sendable {
  /** Constructor. Telemetry/log name defaults to the classname. */
  @SuppressWarnings("this-escape")
  public HowdySubsystem() {
    String name = this.getClass().getSimpleName();
    name = name.substring(name.lastIndexOf('.') + 1);
    SendableRegistry.addLW(this, name, name);
    DebugCommandScheduler.getInstance().registerSubsystem(this);
  }
   ...
   */
  @SuppressWarnings("this-escape")
  public HowdySubsystem(String name) {
    SendableRegistry.addLW(this, name, name);
    DebugCommandScheduler.getInstance().registerSubsystem(this);
  }
