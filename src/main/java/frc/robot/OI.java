...
public class OI extends OI_Utils {
  ...
  public static final class Driver {
    ...
    // Control Curves
    private static final ControlCurve xTranslationCurve = new ControlCurve(0.75, 0, 1, 0.1, true);
    private static final ControlCurve yTranslationCurve = new ControlCurve(0.75, 0, 1, 0.1, true);
