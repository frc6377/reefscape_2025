...
public class OI extends OI_Utils {
  ...
  public static final class Driver {
    ...
    private static final ControlCurve xTranslationCurve = new ControlCurve(1, 0, 1, 0.1, true);
    private static final ControlCurve yTranslationCurve = new ControlCurve(1, 0, 1, 0.1, true);
    public static final ControlCurve translationMagnitudeCurve = new ControlCurve(1, 0, 1, 0.1);
    public static final ControlCurve rotationCurve = new ControlCurve(1, 0, 1, 0.1, true);
    // Joystick Axes
