...
public class Vision extends SubsystemBase {
  ...
  public Vision(QuestNav questNav, VisionConsumer consumer, VisionIO... io) {
  ...
  public void periodic() {
    if (kUsingQuestNav) {
      ...
      consumer.accept(pose, questNav.timestamp(), VecBuilder.fill(0.1, 0.1, 0.1));
      Logger.recordOutput("Vision/QuestNavPose", pose);
