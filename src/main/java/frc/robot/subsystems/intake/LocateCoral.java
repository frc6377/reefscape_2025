...
public class LocateCoral extends Command {
  ...
  public LocateCoral(Supplier<CoralEnum> state, IntakeSubsystem subsystem) {
  ...
  public void execute() {
    switch (state.get()) {
      ...
      case CORAL_TOO_CLOSE:
        this.intakeSubsystem.setIntakeMotor(kIntakeSpeed / 5);
        this.intakeSubsystem.setConveyerMotor(-kConveyorSpeed);
        break;
      case CORAL_TOO_FAR:
        this.intakeSubsystem.setIntakeMotor(kIntakeSpeed / 5);
        this.intakeSubsystem.setConveyerMotor(kConveyorSpeed);
