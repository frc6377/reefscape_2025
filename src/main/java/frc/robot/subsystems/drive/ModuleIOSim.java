...
public class ModuleIOSim implements ModuleIO {
  ...
  private static final double DRIVE_KV = driveMotorGains.kV;
  ...
  public ModuleIOSim(SwerveModuleSimulation moduleSimulation) {
    ...
    this.driveController =
        new PIDController(driveMotorGains.kP, driveMotorGains.kI, driveMotorGains.kD);
    this.turnController =
        new PIDController(steerMotorGains.kP, steerMotorGains.kI, steerMotorGains.kD);
